...
import static snakeandladder.Game.size;
import java.applet.*;
/**
 *
 * @author DHRUV
...
public class NewApplet extends JApplet {
    ...
    public void initComponents() {
        ...
        for(int i=0;i<n*n;i++)
        {
           box[i].addMouseListener(new NewApplet.Mouseclickforsandl());
        }
        }
  ...
  return bottom;
    ...
    public void init(String players,String boardsize,String snakes,String ladders,boolean isconf,String player1,String player2,String player3){
       initComponents();
